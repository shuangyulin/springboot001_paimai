...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      obj.jiage = parseFloat(obj.jiage) + parseFloat(this.ruleForm.jiage)
      this.$http({
          url: `${table}/update`,
          method: "post",
          data: obj
        ...
        if (valid) {
          this.$http({
            url: `lishijingpai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lishijingpaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
